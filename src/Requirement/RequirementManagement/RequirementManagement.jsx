...
const RequirementManagement = () => {
  ...
  const handleEdit = (requirementid) => {
    ...
    const rowToEdit = searchResults.find(
              ...
              <tr key={item.requirementid}>
                <td>
                  {editMode === item.requirementid ? (
                    <input
                      type="text"
                      value={editedValues.requirementid}
                      disabled
                    />
                  ) : (
                    item.requirementId
                ...
                <td>
                  {editMode === item.requirementid ? (
                    <input
                      ...
                      onChange={(e) => handleEditInputChange(e, "experience")}
                    />
                  ) : (
                    item.experience
                  )}
                ...
                <td>
                  {editMode === item.requirementid ? (
                    <input
                      type="text"
                      value={editedValues.sector}
                      onChange={(e) => handleEditInputChange(e, "sector")}
                    />
                  ) : (
                    item.sector
                  )}
                ...
                <td>
                  {editMode === item.requirementid ? (
                    <input
                      type="text"
                      value={editedValues.technology}
                      onChange={(e) => handleEditInputChange(e, "technology")}
                    />
                  ) : (
                    item.technology
                  )}
                ...
                <td>
                  {editMode === item.requirementid ? (
                    ...
                    <>
                      <button
                        className="btnedit"
                        onClick={() => handleEdit(item.requirementid)}
                      >
                      ...
                      <button
                        className="btndelete"
                        onClick={() => handleDelete(item.requirementid)}
                      >
