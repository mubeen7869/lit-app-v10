...
<div className="side_by_side">
 ...
 <div className="side_by_side">
  ...
  {/* <div className="side_by_side">
    ...
    pattern="[A-Za-z0-9 ]+"  // Allow letters, numbers, and spaces
    title="Remark must contain only letters, numbers, and spaces"
    required
/>
{remark && !/^[A-Za-z0-9 ]+$/.test(remark) && (
    <p className="error-message">Remark must contain only letters, numbers, and spaces</p>
)}
